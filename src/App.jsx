    ...
    <>
      ...
      <div className="proyek mt-32 py-10" id="proyek">
        ...
        <p
          ...
          data-aos-once="true"
        >
          Berikut ini beberpa proyek yaang telah saya buat
        </p>
        <div className="proyek-box mt-14 grid lg:grid-cols-3 sd:grid-cols-2 grid-cols-1 gap-4">
      ...
      <div className="kontak mt-32 sm:p-10 p-0" id="kontak">
        ...
        <form
          action="https://formsubmit.co/anandokardiko1122@gmail.com"
          method="POST"
        ...
        >
          <div className="flex flex-col gap-6">
            ...
            <div className="text-center bg-violet-700 p-3 rounded-lg w-full cursor-pointer border border-zinc-600 hover:bg-violet-600">
